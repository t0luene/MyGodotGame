...
@onready var floor_dropdown: OptionButton = $ManagePanel/LeftPanel/FloorDropdown
@onready var floor_image: TextureRect = $ManagePanel/LeftPanel/FloorImage
@onready var floor_name_label: Label = $ManagePanel/LeftPanel/FloorNameLabel
@onready var power_bar: TextureProgressBar = $ManagePanel/RightPanel/PowerBar
...
func _ready():
	...
	var slots_grid = $ManagePanel/RightPanel/EmployeeSlotsGrid
...
func get_slot_button(slot_index: int) -> Button:
	return $ManagePanel/RightPanel/EmployeeSlotsGrid.get_child(slot_index)
...
func load_employee_slots():
	...
	$ManagePanel/RightPanel/PowerBar.value = assigned_count
